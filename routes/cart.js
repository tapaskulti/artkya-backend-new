...
const { createCart, addToCart, removeFromCart, cartByUserId, clearCartByUserId } = require("../controllers/cartController");
...
router.route("/clearCartByUserId").patch(clearCartByUserId)
